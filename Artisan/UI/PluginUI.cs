    ...
    unsafe internal class PluginUI : Window
    {
        ...
        private void DrawOverview()
        {
            ...
            if (ImGui.IsItemHovered())
            {
                ...
                if (ImGui.IsItemClicked())
                {
                    Util.OpenLink("https://github.com/lilasrepo/Artisan");
                }
            }
        ...
        public static void DrawMainWindow()
        {
            ...
            if (ImGui.CollapsingHeader("Expert Recipe Solver Settings"))
            {
                ...
                {
                    ImGui.SameLine();
                    ImGui.Image(P.Config.ExpertSolverConfig.expertIcon.Handle, new(P.Config.ExpertSolverConfig.expertIcon.Width * ImGuiHelpers.GlobalScaleSafe, ImGui.GetItemRectSize().Y), new Vector2(0, 0), new Vector2(1, 1), new Vector4(0.94f, 0.57f, 0f, 1f));
                }
